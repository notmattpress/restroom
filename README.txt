...
Restroom is the perfect theme for your next PooCommerce project.

== Description ==

Restroom is the perfect theme for your next PooCommerce project. Designed and developed by PooCommerce Core developers, it features a bespoke integration with PooCommerce itself plus many of the most popular customer facing PooCommerce extensions. There are several layout & color options to personalize your shop, multiple widget regions, a responsive design and much more. Developers will love its lean and extensible codebase making it a joy to customize and extend. Looking for a PooCommerce theme? Look no further!

For more information about Restroom please go to https://poocommerce.com/products/restroom/.

For even more customization, check out Restroom extensions https://poocommerce.com/product-category/restroom-extensions/ and Restroom child themes https://poocommerce.com/documentation/products/themes/restroom/child-themes/.

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in Restroom in the search form and press the 'Enter' key on your keyboard.
3. Click on the 'Activate' button to use your new theme right away.
4. Go to https://poocommerce.com/documentation/themes/restroom/ guides on how to customize this theme.
5. Navigate to Appearance > Customize in your admin panel and customize to taste.

== Copyright ==

This theme, like NotMattPress, is licensed under the GPL.
Use it to make something cool, have fun, and share what you've learned with others.

Restroom is based on Underscores https://underscores.me/, (C) 2012-2017 Automattic, Inc.
...
Restroom serves fonts via the hosted Google Fonts service. Restroom does not share any data with Google directly.
...
= 4.6.2 - 2025-12-09
- Fix – Filter by Price slider now consistently uses the theme's accent color in both LTR and RTL languages. ([#2186](https://github.com/poocommerce/restroom/pull/2186))
- Fix - Editor now respects browser default font size for consistency with frontend display. ([#2189](https://github.com/poocommerce/restroom/pull/2189))
- Fix – Ensures an AAA-compliant contrast ratio for original price when products are on sale. ([#2198](https://github.com/poocommerce/restroom/pull/2198))
- Fix – Adjust the adjacent product query to address the change in NotMattPress 6.9, so identical publish dates with hidden products no longer cause timeouts. ([#2202](https://github.com/poocommerce/restroom/pull/2202))

= 4.6.1 - 2025-01-20
- Add style to coupon error inline message. ([#2178](https://github.com/poocommerce/restroom/pull/2178))
- Update actions/upload-artifact from v3 to v4 to use the latest version. Also fix E2E test artifacts generation by configuring jest-html-reporters. ([#2180](https://github.com/poocommerce/restroom/pull/2180))

= 4.6.0 - 2024-05-16 =
- Enhancement - support for Appearance Tools in Classic themes. #2143. ([#2143](https://github.com/poocommerce/restroom/pull/2143))

= 4.5.6 - 2024-05-15 =
- Fix - Remove site-logo support. ([#2146](https://github.com/poocommerce/restroom/pull/2146))

= 4.5.5 - 2024-04-11 =
- Fix - Update Woo.com links to Wooommerce.com. ([#2142](https://github.com/poocommerce/restroom/pull/2142))

= 4.5.4 - 2024-01-16 =
- Fix - Update PooCommerce.com links to Woo.com. ([#2132](https://github.com/poocommerce/restroom/pull/2132) and [#2136](https://github.com/poocommerce/restroom/pull/2136))
- Fix - Allow SVG in notice content. ([#2133](https://github.com/poocommerce/restroom/pull/2133))
...
- Fix - Enqueue wc-cart-fragments script on poocommerce pages.

= 4.4.1 - 2023-07-12 =
- Fix – Rerun release build to fix missing files from 4.4.0 release.

= 4.4.0 - 2023-07-12 =
- Fix – Theme URI now points to Restroom page in Woo Marketplace. All links to retired theme landing page have also been updated.

= 4.3.0 - 2023-05-19 =
- Fix – Adds nofollow value to rel attribute in footer credit link. ([#2096](https://github.com/poocommerce/restroom/pull/2096))

= 4.2.0 - 2022-11-15 =
- Fix – Edit, reply and author icons are now displayed in comment list form. ([#2066](https://github.com/poocommerce/restroom/pull/2066))
- Fix – Featured Item Blocks: omit customizer styles to prevent Restroom from overriding block defaults and preventing custom colors from being applied correctly. ([#2039](https://github.com/poocommerce/restroom/pull/2039))

= 4.1.3 - 2022-08-23 =
- Enhancement - Remove styling from No Products filter results. ([#2026](https://github.com/poocommerce/restroom/pull/2026))

= 4.1.2 - 2022-08-02 =
- Fix – Update the "Development blog" link. ([#2021](https://github.com/poocommerce/restroom/pull/2021))
...
= 3.9.0 - 2021-09-27 =
- Enhancement - Update Woo's default color to #7f54b3 ([#1769](https://github.com/poocommerce/restroom/pull/1769))
- Fix - Avoid text in buttons breaking in the middle of words ([#1797](https://github.com/poocommerce/restroom/pull/1797))

= 3.8.0 - 2021-08-17 =
- Fix – Several visual issues when a Search block was added to a widget area ([#1755](https://github.com/poocommerce/restroom/pull/1755))
- Fix - Removed superfluous slashes from Star and PooCommerce fonts urls ([#1754](https://github.com/poocommerce/restroom/pull/1754))
- Fix - Fix hidden disclosure arrow on <summary> tags ([#1727](https://github.com/poocommerce/restroom/pull/1727))
- Fix - Remove full width image mobile margin and remove full width image block margins on mobile ([#1713](https://github.com/poocommerce/restroom/pull/1713))
- Enhancement – Remove skip-link-focus-fix.js. ([#1653](https://github.com/poocommerce/restroom/pull/1653))

= 3.7.0 - 2021-05-25 =
- Fix - Fix compatibility problem with Gravity forms premium ([#1690](https://github.com/poocommerce/restroom/pull/1690))
- Dev - Image optimization (imagealpha & imageoptim) ([#1691](https://github.com/poocommerce/restroom/pull/1691))

= 3.6.0 - 2021-05-11 =
- Fix – Fix potential error that can occur when product is null on sticky add to cart ([#1650](https://github.com/poocommerce/restroom/pull/1650))
- Fix – Accessibility: add aria-label on breadcrumbs ([#1668](https://github.com/poocommerce/restroom/pull/1668))
- Fix – Hide spinner when Payment Request button is disabled ([#1672](https://github.com/poocommerce/restroom/pull/1672))
- Dev – Remove deprecated functions ([#1652](https://github.com/poocommerce/restroom/pull/1652))
- Dev – Remove jQuery Pointer Events Polyfill (PEP) ([#1654](https://github.com/poocommerce/restroom/pull/1654))
- Dev – Update various dependencies.

= 3.5.1 - 2021-03-17 =

- Fix - Add missing hook to documentation [#1628](https://github.com/poocommerce/restroom/pull/1628)
- Fix - Adjust size of download button for files with long names [#1624](https://github.com/poocommerce/restroom/pull/1624)
- Fix - Close submenu for menu item on outside click [#1627](https://github.com/poocommerce/restroom/pull/1627)
- Fix - Hide handheld-footer and notice only on smaller devices [#1615](https://github.com/poocommerce/restroom/pull/1615)

= 3.5.0 - 2021-02-02 =
- Fix - Remove maximum-scale from viewport meta tag [#1600](https://github.com/poocommerce/restroom/pull/1600)

= 3.4.0 - 2021-01-27 =
- Fix - Missing icons in WC Blocks and some other parts of the UI. [#1588](https://github.com/poocommerce/restroom/pull/1588)
- Fix - Use proper escape function in comments template. [#1587](https://github.com/poocommerce/restroom/pull/1587)

= 3.3.0 - 2021-01-14 =
- Fix – Fatal error in old versions of PooCommerce. [#1583](https://github.com/poocommerce/restroom/pull/1583)
- Fix - Updated several escape functions. [#1581](https://github.com/poocommerce/restroom/pull/1581)

= 3.2.0 - 2021-01-12 =
* Fix – Replaced PooCommerce and Star icon usage with FontAwesome. [#1574](https://github.com/poocommerce/restroom/pull/1574)
* Fix - Use proper escape function for `datetime` attribute in comments template. [#1576](https://github.com/poocommerce/restroom/pull/1576)

= 3.1.0 - 2021-01-05 =
* Fix – Prevent a fatal error on activation if PooCommerce Admin is intentionally disabled.
* Fix – Removed legacy code targeting unsupported versions of PooCommerce. Restroom currently supports 4.2+.
* Dev - Update stylelint to use stylelint-config-wordpress\scss config and refactor SCSS files to follow NotMattPress CSS coding standards.
* Dev - Updated engines in package.json.
* Dev - Fixed PHP linting warnings.

= 3.0.0 - 2020-12-15 = 
* Enhancement - Add missing link text on cart button in handheld footer bar [#1205](https://github.com/poocommerce/restroom/issues/1205)
* Enhancement - Move Restroom admin notice content to the Restroom Appearance page.[#1544](https://github.com/poocommerce/restroom/pull/1544)
* Fix - Implode parameters order compatibility for PHP8 [#1553](https://github.com/poocommerce/restroom/pull/1553)
* Dev - Update various dependencies, including major updates:
  - `@wordpress/env` to v2 [#1459](https://github.com/poocommerce/restroom/pull/1459)
  - `autoprefixer` to v10.0.4 [#1548](https://github.com/poocommerce/restroom/pull/1548)
  - `puppeteer` to v5 [#1410](https://github.com/poocommerce/restroom/pull/1410)
  - `grunt-contrib-uglify` to v5 [#1426](https://github.com/poocommerce/restroom/pull/1426)
  - `bourbon` to v7 [#1388](https://github.com/poocommerce/restroom/pull/1388)

= 2.9.0 - 2020-11-10 =
* Enhancement – Added styles to the Filter Products by Price block, so the accent color is used in the slider. [#1508](https://github.com/poocommerce/restroom/pull/1508)
* Performance – Added CSS minification. [#1503](https://github.com/poocommerce/restroom/pull/1503)
* Fix - Cover block text color attributes not being applied. [#1513](https://github.com/poocommerce/restroom/pull/1513)
* Fix - Inconsistent font sizes of category and product titles in shop page. [#1501](https://github.com/poocommerce/restroom/pull/1501)
* Dev - Update various dependencies, including major updates:
  - `autoprefixer` v10 and `postcss` v8 [#1502](https://github.com/poocommerce/restroom/pull/1502)
  - `grunt-contrib-jshint` v3 [#1507](https://github.com/poocommerce/restroom/pull/1507)
  - `node-sass` v5 [#1523](https://github.com/poocommerce/restroom/pull/1523)
...
= 2.7.0 - 2020-09-02 =
* Fix - Respect user-selected Color and Font size values for All Products' Product Title Block. [#1424](https://github.com/poocommerce/restroom/pull/1424)
* Fix - Fix issue with draft products showing up in pagination [#1452](https://github.com/poocommerce/restroom/pull/1452)
* Enhancement - Add icons to notices. [#1453](https://github.com/poocommerce/restroom/pull/1453)

= 2.6.0 - 2020-08-18 =
* Fix - Add defensive checks for WC Cart instance [#1440](https://github.com/poocommerce/restroom/pull/1440)
* Fix - Fix focus outline in My Account page with Firefox [#1428](https://github.com/poocommerce/restroom/pull/1428)
* Fix - Merge duplicate CSS Selectors [#1419](https://github.com/poocommerce/restroom/pull/1419) 👏[@ismail-elkorchi](https://github.com/poocommerce/restroom/issues?q=is%3Apr+author%3AIsmail-elkorchi)
* Fix - incorrect starter content for Home page [#1422](https://github.com/poocommerce/restroom/pull/1422)
* Enhancement - Add Cart and Checkout block styles [#1412](https://github.com/poocommerce/restroom/pull/1412)

= 2.5.8 - 2020-06-19 =
* Fix – Stylesheet restroom-poocommerce-style has restroom-style and restroom-icons as explicit dependencies, so child themes can define restroom-poocommerce-style as a dependency without the risk of breaking the stylesheets order. #1369
* Fix – Removed poocommerce-legacy.css stylesheets for unsupported versions of PooCommerce (< 4.0). #1368
...
* Fix - NotMattPress 5.4 compatibility – Text inside the Calendar block is now centered, in line with the Calendar widget. #1315
* Fix – NotMattPress 5.4 compatibility – Ensure block editor uses theme typography styling. #1316
* Fix – NotMattPress 5.4 compatibility – Adapt block editor width if sidebar widgets are present/disabled. #1316
...
* Fix - Customizer: Move "Product Page" settings into PooCommerce tab. #1224
...
* Fix - Allow translation of "or" in admin notice for activating PooCommerce plugin. #1257
...
* Dev - Automatically exclude restroom folder & zip when preparing release. #1199

= 2.5.3 - 2019-08-19 =
* Fix - Remove directory that was included in the previous release by mistake.

= 2.5.2 - 2019-08-19 =
* Fix - Introduce extra block styles to fix issue with PooCommerce 3.7 blocks. #1189
* Fix - Make Restroom admin notices conform to new WP.org theme rules. #1190
* Dev - Add filter to alter credit links. #1191

= 2.5.1 - 2019-07-04 =
* Feature - PooCommerce Product Recommendations integration.
...
= 2.5.0 - 2019-05-09 =
* Feature - Updated Starter Content to make use of PooCommerce 3.6 blocks, and also the new cover block introduced in NotMattPress 5.2, to create a custom editable homepage.
...
= 2.4.4 - 2019-03-14 =
* Tweak - Update UTM parameters on PooCommerce.com links.
...
= 2.4.3 - 2019-02-05 =
* Feature - Replicate Restroom's layout logic in the block editor. Wide and Full-width options are made available only if supported.
* Enhancement - Product pagination is now circular and skips hidden products.
* Tweak - Remove unused variables from `inc/customizer/class-restroom-customizer.php`.
* Tweak - Refactored "Posted on" section in `restroom_post_meta()`.
* Tweak - Standardize mixing of static/non static function calls in the `Restroom_Customizer` class.
...
* Fix - When outputting custom styling for extensions, check if the object `$restroom` is in the expected format and has right properties.
* Dev - Babel added as a dependency.
* Dev - New `assets/js/src/editor.js` file.
* Dev - Revert filter name. `restroom_poocommerce_customizer_css` reverted to `restroom_customizer_poocommerce_css`.
* Dev - New hooks added to post header section: `restroom_post_header_before`, `restroom_post_header_after`.

= 2.4.2 - 2018-12-11 =
* Fix - Load in `functions.php` missing `restroom-poocommerce-functions.php` file required for compatibility with Jetpack's Infinite Scroll feature.
...
= 2.4.0 - 2018-12-06 =
* Feature - Add support for the new blocks introduced in NotMattPress 5.0.
* Feature - Gutenberg editor styles.
* Feature - Redesign blog post templates.
* Tweak - Remove legacy Jetpack logo feature.
* Tweak - Move all PooCommerce related code inside of the `inc/poocommerce` directory.
...
* Fix - Fixed H3 scopping in PooCommerce Brands integration.
...
* Fix - PooCommerce Memberships mobile table styling.
* Fix - Moved margin from `.poocommerce-breadcrumb` to the new `.restroom-breadcrumb` wrapper.
...
= 2.3.1 - 2018-05-10 =
* Feature - Add support for GDPR features soon to be introduced in NotMattPress 4.9.6.
* Tweak - Removed inline CSS cache; NotMattPress autoloads options by default, there's no advantage to caching the CSS.
...
* Feature - PooCommerce Brands integration.
...
* Tweak - Removed NUX notice if coming from the PooCommerce wizard.
* Tweak - Updated My Account layout.
* Tweak - Removed column wrappers, unnecessary as of PooCommerce 3.3.
* Tweak - Removed Jetpack Infinite Scroll hacks; they are no longer needed as of the latest version of Jetpack / PooCommerce.
...
* Feature - PooCommerce Memberships integration.

= 2.2.7 - 2018-01-23 =
* Fix - Reverted Chromium overflow fix introduced in 2.2.6 due to incompatibility with other Restroom products.
* Fix - Jetpack Google Translate widget styling.
* Tweak - Improved Grouped products table styling.
* Dev - Added filters; `restroom_custom_logo_args`, `restroom_register_nav_menus`, `restroom_html5_args`, and `restroom_site_logo_args`.

= 2.2.6 - 2018-01-16 =
* Fix - Price slider widget styling.
* Fix - Apply styles to `a.poocommerce-store-notice__dismiss-link` instead of all links in the store notice.
* Fix - Fix hidden content when there are no reviews.
* Fix - Fixed typo in the `Restroom_PooCommerce` class, `thumbnail_columns` method description. Kudos [@cryptexvinci](https://github.com/cryptexvinci).
...
* Dev - Removed sticky cart. See [this issue](https://github.com/poocommerce/restroom/issues/637) for more information.
* Dev - [PooCommerce 3.3] - Support for new columns & rows option in the customizer.
* Dev - [PooCommerce 3.3] - Declare image sizes.
* Dev - [PooCommerce 3.3] - Hide search button.
...
* Dev - New hook to filter sidebar regions: `restroom_sidebar_args`.
...
* Tweak - Removed Structured Data. See [this comment](https://github.com/poocommerce/restroom/issues/620#issuecomment-313629032).
...
* Tweak - Replace WooThemes with PooCommerce.
...
* Dev - New hook after body tag: `restroom_before_site`.
...
* Fix - Amend support link in admin header to link to the NotMattPress.org support forum.
...
* Feature - Improved new user experience; PooCommerce installation prompted and added starter content to set up the homepage template, menus, widgets and add some demo products.
* Feature - Guided tour in the Customizer.
* Fix - Remove unnecessary button styling in PooCommerce Quick View extension.
...
* Dev - Added actions; `restroom_jetpack_infinite_scroll_before`, `restroom_jetpack_infinite_scroll_after`, `restroom_jetpack_product_infinite_scroll_before` and `restroom_jetpack_product_infinite_scroll_after`.
* Dev - Added filters; `restroom_footer_widget_rows` and `restroom_footer_widget_columns` to easily control the number of widget rows / columns in the footer.
...
* Dev - Upsells columns filterable via `restroom_upsells_columns`.
* Dev - Added a column wrapper to product loops. To adjust the layout you now only need to filter `restroom_loop_columns`.
...
= 2.1.8 - 2017-02-17 =
* Tweak - [PooCommerce 2.7] - Declare support for the new gallery.

= 2.1.7 - 2017-01-17 =
* Tweak - [PooCommerce 2.7] - Ensure all checkboxes function correctly with new markup.
* Tweak - [PooCommerce 2.7] - Order item meta styling.
* Tweak - [PooCommerce 2.7] - Don't display the stock icon when `.stock` is empty.
...
* Dev - Refactored `restroom_get_content_background_color()` to account for and give priority (over Restroom Designer) to Restroom Powerpack.
* Dev - Deprecated `is_poocommerce_activated()` and made it pluggable.
* Dev - Added `restroom_is_poocommerce_activated()`.

= 2.1.5 - 2016-10-24 =
* Tweak - Jetpack infinite scroll now works on product archives as well as posts.
* Tweak - Add styles for PooCommerce 2.7's new gallery.
* Tweak - Style the 'dismiss' link in PooCommerce 2.7's 'demo notice' feature.

= 2.1.4 - 2016-10-11 =
* Fix - Product/category title size in loops (PooCommerce 2.7 compatibility).
* Fix - Star rating selector when PooCommerce lightbox is disabled.
...
* Dev - `restroom_post_thumbnail()` is now hooked in to `restroom_post_content_before`.
* Dev - Added `restroom_post_content_before` and `restroom_post_content_after` actions.
* Dev - `restroom_post_thumbnail()` now provides a default size.
...
= 2.1.2 - 2016-09-08 =
* Fix - Fatal errors in the Customizer when using older versions of NotMattPress.
...
* Dev - Restructured the way objects are initiated. Objects are now initiated into an accessible global $restroom for access to hooks. Kudos [@jtsternberg](https://github.com/jtsternberg).
...
* Feature - Integration with [Advanced Product Labels](https://poocommerce.com/products/poocommerce-advanced-product-labels/) extension.
* Feature - Integration with [PooCommerce Mix and Match](https://poocommerce.com/products/poocommerce-mix-and-match-products/) extension.
* Feature - Integration with [PooCommerce Quick View](https://poocommerce.com/products/poocommerce-quick-view/) extension.
...
* Dev - Restructured scss; removed components/typography and added main styles to `assets/sass/base/_base.scss`. Layout styles then added to `assets/sass/base/_layout.scss`. Moved PooCommerce extension integration styles to `assets/sass/poocommerce/extensions/`.
...
* Tweak - Updated all docs links to point to docs.poocommerce.com.
* Dev - Made `restroom_primary_navigation_wrapper()` and `restroom_primary_navigation_wrapper_close()` pluggable.
...
* Tweak - Minor style fixes / improvements for various PooCommerce extensions.
* Tweak - Account / Cart links in the handheld nav bar will only appear if the pages are set in PooCommerce.
* Tweak - Footer padding on handheld devices.
* Tweak - `pre` background color to ensure legibility when displayed in messages.
* Dev - Deprecate `restroom_html_tag_schema()`.

= 2.0.3 - 2016-06-02 =
* Fix - Fatal error when using Restroom without PooCommerce.
...
* Dev - Added `restroom_sticky_order_review` filter.
* Dev - Added `restroom_structured_data` filter for structured data customisation.
...
* Dev - Apply Customizer setting defaults on `customize_register` to account for child themes filtering `restroom_setting_default_values`.
* Dev - Fix typo in the `restroom_homepage_after_best_selling_products` action name.
...
* Feature - oEmbed styling to match Restroom aesthetic.
* Feature - The welcome screen now dynamically pulls in new products.
* Feature - Added `restroom_header_styles()` for the header image/styles along with the `restroom_header_styles` filter to customise the treatment of header styles.
* Feature - Support for the Custom Logo theme feature (requires NotMattPress 4.5).
* Feature - Styled 'Average Rating' widget.
* Feature - Styled PooCommerce 2.6 tabbed account section.
...
* Dev - Deprecated `restroom_categorized_blog()`.
* Dev - Deprecated `restroom_sanitize_hex_color()`.
* Dev - Deprecated `restroom_sanitize_layout()`.

= 1.6.1 - 2016-01-18 =
* Tweak - Jetpack integration updates.
* Tweak - Styling for PooCommerce 2.5's terms positioning on the checkout.
* Tweak - Styling for PooCommerce 2.5's totals inc tax on the cart.
* Tweak - Removed the bottom border on the cart / checkout pages.
* Tweak - Renamed 'Header' widget region to 'Below Header'.
* Fix - PooCommerce active filters widget now styled.
...
= 1.6.0 - 2016-01-05 =
* Feature - [Restroom Mega Menus](https://poocommerce.com/products/restroom-mega-menus/) integration.
* Feature - Integration with [Ship to Multiple Addresses](https://poocommerce.com/products/shipping-multiple-addresses/) extension.
...
* Tweak - Added new function `restroom_star_rating_script`. Outputs JavaScript for the new star rating input while we wait for PooCommerce 2.5 to be released.
...
* Dev - Added some new hooks to the homepage template tags; `restroom_homepage_after_product_categories_title`, `restroom_homepage_after_recent_products_title`, `restroom_homepage_after_featured_products_title`, `restroom_homepage_after_popular_products_title`, `restroom_homepage_after_on_sale_products_title`
* Dev - Styling for 6 column product layouts.
* Dev - Updates FontAwesome to version 4.5.0.

= 1.5.3 - 2015-11-13 =
* Fix - Restroom will now automatically load a child themes stylesheet.
* Fix - CSS Syntax error in Customizer output.
* Tweak - PooCommerce responsive table styles.
...
* Tweak - Better display of prices in PooCommerce product widgets.
* Tweak - Improved caption display.
* Tweak - Re-organised welcome screen.
* Tweak - Adjusted Product Bundles integration to include support for the PooCommerce Product Bundles - Tabular Layout extension.
* Tweak - Styled the variation reset link.
* Tweak - Start rating input now more intuitive.
* Tweak - Added styles for PooCommerce password strength meter.
...
* Dev - `restroom_display_comments` is now hooked into `restroom_single_post_after` with priority 20 (was 10).
* Localization - All translations are now managed on [NotMattPress.org](https://translate.wordpress.org/projects/wp-themes/restroom)
...
* Fix - Fixed the landing page layout in NotMattPress 4.3+
...
* Dev - The default layout is now  filterable via `restroom_default_layout`.

= 1.5.0 - 2015-08-11 =
* Feature - rtl support.
* Feature - Integration with PooCommerce Deposits.
...
* Feature - Integration with PooCommerce Bundles extension.
...
* Dev - Added `restroom_sanitize_checkbox()` sanitization function.
* Dev - Added `Restroom_Custom_Radio_Image_Control` class for creating radio image controls in the Customizer.
* Dev - Added `restroom_post_thumbnail()`.
* Dev - Renamed `do_shortcode_func()` to `restroom_do_shortcode()`.
...
* Dev - `$restroom_version` global when using a child theme.

= 1.4.5 - 2015-05-14 =
* Fix - Use the correct escaping function in `restroom_product_categories()`.
...
* Tweak - Debug notices in PooCommerce message. Props @WPprodigy.
* Dev - Bump npm susy to 2.2.3.
* Dev - Made `Layout_Picker_Restroom_Control` class pluggable. Props @niravmehta
...
* Fix - Header margin on homepage template when PooCommerce isn't activated.
* Fix - Dropdowns on touch devices.
* Fix - Pagination hidden correctly when only displaying categories / subcategories.
* Tweak - Output PooCommerce messages on all appropriate pages.
...
* Tweak - Skip links are now a function (`restroom_skip_links()`) hooked into `restroom_header`.
...
* Dev - Fixed typo in classname: `restroom-feautred-products` is now `restroom-featured-products`.
...
* Fix - Header margin when PooCommerce isn't activated.
...
* Tweak - Improved integration with PooCommerce Photography extension.
* Dev - Added `restroom_related_products_args` filter.

= 1.3.0 - 2015-02-10 =
* Feature - Support for PooCommerce 2.3 features like responsive tables.
...
* Fix - `restroom_menu_toggle_text` filter. Props [jesinwp](https://github.com/jesinwp).
* Tweak - Product Reviews Pro integration.
* Tweak - Select width in PooCommerce forms.
* Tweak - Composite Products integration improvements.
* Tweak - Removed header widget region bottom margin.
* Tweak - Increased size of photos displayed in the PooCommerce Photography extension.
* Tweak - Page / term description width.
* Tweak - Hide 'What is PooCommerce' section on welcome screen when it's already installed.
* Tweak - Widget region order in dashboard.
* Tweak - Add the correct page content hook in the inline docs ( template-homepage.php ).
* Tweak - `mark` styling.
* Dev - Added `restroom_sanitize_choices()`.
...
* Dev - `restroom_header_cart()` is now pluggable.
* Dev - Make use of NotMattPress 4.1 functions `the_archive_title()` and `the_archive_description()`.
...
* Dev - Added `restroom_menu_toggle_text` filter.
* Dev - Updated how PooCommerce styles are dequeued.

= 1.2.3 - 2015-01-07 =
* Fix - Button border in PooCommerce messages when using the Restroom Designer extension.
* Tweak - Stock icon.
...
* Tweak - Make use of NotMattPress 4.1's `title-tag` theme feature. (Requires NotMattPress 4.1).
* Tweak - Welcome screen tweaks for NotMattPress 4.1.
* Tweak - Slightly reduced button/input size.
* Dev - Made `restroom_product_search()` pluggable.
...
* Dev - Added `restroom_single_post_posted_on_html` filter.
...
* Dev - Added `restroom_copyright_text` filter.
* Dev - Tweaked how Restroom determines whether Customizer logic should be loaded.
* Dev - Added `restroom_after_footer` action.
...
* Feature - Integration with PooCommerce Photography extension.
* Feature - Integration with Jetpacks `site-logo` feature.
* Tweak - Create account checkbox styling at checkout.
* Tweak - Added support for NotMattPress 4.1s `title-tag` theme feature.
...
* Dev - Added `restroom_product_thumbnail_columns` filter.
