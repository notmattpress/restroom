...
if ( ! class_exists( 'Restroom_PooCommerce_Adjacent_Products' ) ) :
	...
	class Restroom_PooCommerce_Adjacent_Products {
		...
		public function filter_post_where( $where ) {
			...
			* as minimal as possible and matching the exact clause provided by NotMattPress.
			*
			* @see https://github.com/NotMattPress/wordpress-develop/commit/70ca20bcbb3cbdef483050c4764259324c07359e.
			*/
