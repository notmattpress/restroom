...
if ( ! class_exists( 'Restroom_Customizer' ) ) :
	...
	class Restroom_Customizer {
		...
		public function customize_register( $wp_customize ) {
			 ...
			 * Custom controls
			 */
			require_once __DIR__ . '/class-restroom-customizer-control-radio-image.php';
			require_once __DIR__ . '/class-restroom-customizer-control-arbitrary.php';
			...
			if ( apply_filters( 'restroom_customizer_more', true ) ) {
				require_once __DIR__ . '/class-restroom-customizer-control-more.php';
			}
